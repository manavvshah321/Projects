...
A direct link to the deployable MIRO application can be found [here](https://github.com/manavvshah321/Projects/blob/main/project.miroapp) and a link to the GAMS code behind it can be found [here](https://github.com/manavvshah321/Projects/blob/main/project.gms).
